...
/****** Object:  Job [Capture Poor SQL]    Script Date: 3-3-2020 13:58:42 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 3-3-2020 13:58:42 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Capture Poor SQL', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Capture Poor SQL]    Script Date: 3-3-2020 13:58:42 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Capture Poor SQL', 
		@step_id=1, 
		...
		@command=N'INSERT INTO [<maintenance datbase>].[dbo].[My_Poor_Query_Cache]
SELECT TOP 20
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Hourly', 
		...
		@schedule_uid=N'54dcd681-618d-4a58-ab92-431135b1301e'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
